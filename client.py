    ...
    for row in range(0, 3):
        ...
        for col in range[0,9]:
            if(platform.system()== 'Windows'):
                boxButton = Button(gameWindow, font="chalkboard SE", borderwidth=3, pady=23, padx=22, bg='#fff176', highlightbackground='#fff176',activebackground='#c5ela5')
...
def gameWindow():
    ...
    gameWindow = Tk()
    gameWindow.title("Tambola House")
    ...
    # Add Text
    canvas2.create_text( screen_width/2, screen_height/5, text = "Tambola House", font=("Chalkboard SE",100), fill="white")
